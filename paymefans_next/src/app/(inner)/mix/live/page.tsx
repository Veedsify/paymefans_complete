        ...
        return (
            <div className="p-4 lg:mb-4 mb-20 flex justify-center flex-col items-center">
                ...
                <div className="text-center">
                    ...
                    <Link href="/mix/models/become-a-model" className="block p-2 mx-auto text-sm font-bold text-white bg-primary-dark-pink rounded-lg cursor-pointer w-52 mt-5">Become a Model</Link>
                </div>
            </div>
        );
    }
        ...
        return (
            <div className="p-4 lg:mb-4 mb-20 flex justify-center flex-col items-center">
                ...
                <div className="text-center">
                    ...
                    <Link href="/mix/verification" className="block bg-primary-dark-pink p-2 mx-auto text-sm font-bold text-white rounded-lg cursor-pointer w-52 mt-5">Go to Verification Center</Link>
                </div>
            </div>
        );
    }
