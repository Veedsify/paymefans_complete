...
const SideBar = () => {
    ...
    const LogOut = () => {
        fetch(`${process.env.NEXT_PUBLIC_EXPRESS_URL}/auth/logout`, {
            method: "POST",
            headers: {
                ...
                <div>
                    <div className="flex items-center gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <span className="text-sm text-gray-600">{user ? user.username : "Loading..."}</span>
                        </div>
                    </div>
                    <div className="pt-5 mb-3">
                        <h2 className="flex items-center mb-1 text-xl font-bold leading-none">{data ? data.points.toLocaleString("en-Us") : 0}
                            <span className="ml-2">
